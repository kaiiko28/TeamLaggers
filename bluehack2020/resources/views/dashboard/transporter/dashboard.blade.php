                ...
                @if (count($booking) > 0)
                    @foreach ($booking as $book)
                        <tr>
                            ...
                            <td>
                                <span class="badge @if($book->status == 'pending') badge-warning @elseif($book->status == 'approve') badge-success @else badge-danger @endif">{{$book->status}} </span>
                                
                            </td>
                            <td>

                                <a href="{{ route('book.approved') . '?id=' . $book->id}}"><button type="button" class="btn btn-success px-3"><i class="fas fa-check" aria-hidden="true"></i></button></a>
                                <a href="{{ route('book.declined') . '?id=' . $book->id}}"><button type="button" class="btn btn-danger px-3"><i class="fas fa-trash" aria-hidden="true"></i></button></a>
                    ...
                    <div class="col-sm-4" style="background:#ccc;">
                        ...
                        <div class="profile">
                            ...
                            <tr><th>First name</th> <td>{{Auth::user()->firstname}}</td>
                                ...
                                <tr><th>Role</th> <td>{{Auth::user()->role}}</td>
                                </tr>
